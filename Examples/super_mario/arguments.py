...
def init_args():
    ...
    group.add_argument('--frames', default=10000000, type=int)
    group.add_argument('--epoch_steps', default=3000, type=int)
    ...
    group.add_argument('--e_greedy_decay', default=1000, type=int)
    group.add_argument('--gamma', default=0.99, type=float)
    ...
    group.add_argument('--replay_buffer_size', default=1000000, type=int)
    group.add_argument('--replay_warm_up', default=80000, type=int)
    group.add_argument('--tau', default=30000, type=float)
    ...
    group.add_argument('--distributional_v_min', default=-30, type=int)
